	...
	<!--================ Start Welcome to Forefront Certification =================-->
	<section class="section_gap gray-bg">
		<div class="container-fluid">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-9 col-md-9 col-sm-12 about-right">
				...
				<div class="wow fadeInRight col-lg about-right text-center">
					...
					<a data-scroll href="#container_list_training" class="my-2 p-3 text-orange border-2px border border-orange hover-effect-1 d-block">
						Training at Forefront
					</a>
				</div>
			</div>
		</div>
	</section>
	<!--================ End Welcome to Forefront Certification =================-->

	<!--================ Start Certification with Forefront =================-->
	<section class="section_gap bg-dark" id="container_list_certification">
		<div class="container-fluid">
			<div class="main-title wow fadeInDown" data-wow-duration="1.5s">
				<h1 class="text-white">ISO Certification with Forefront</h1>
			</div>
	...
	<!--================ End Certification with Forefront =================-->

	<!--================ Start Training with Forefront =================-->
	<section class="section_gap" id="container_list_training">
		<div class="container-fluid">
			<div class="main-title wow fadeInDown" data-wow-duration="1.5s">
				<h1>Training at Forefront</h1>
			</div>
